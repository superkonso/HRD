...
@section('title', Auth::User()->cPanel->TCpanel_AppName.' | Tarif HD Baru')

@section('content_header', 'Tambah Tarif HD')
...
<div class="row">
	    <div class="col-md-12 col-sm-12 col-xs-12">
	        <div class="box box-primary">
	            ...
	            <div class="box-body">
	                <form class="form-horizontal form-label-left" action="/tarifhd" method="post" novalidate data-parsley-validate onsubmit="return checkDataHD()">
		                ...
		                <div class="form-group">
		                    ...
		                    <div class="col-md-6 col-sm-6 col-xs-12">
		                      <input type="text" id="nama" class="form-control col-md-7 col-xs-12" name="nama" placeholder="Tarif Nama">
		                    </div>
		                </div>

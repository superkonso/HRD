...
@section('title', Auth::User()->cPanel->TCpanel_AppName.' | Wilayah Create')

@section('content_header', 'Create Wilayah')
	    ...
	    <div class="col-md-12 col-sm-12 col-xs-12">
	        <div class="box box-primary">
	            <div class="box-header">
	                ...
	                @endif
	                <h3 class="box-title">Form Input Wilayah Baru</h3>
	            </div>
	            <div class="box-body">
	                <form class="form-horizontal form-label-left" action="/wilayah" method="post" novalidate data-parsley-validate onsubmit="return checkDataWil()">
		                {{ csrf_field() }}
		                <div class="form-group">
		                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="kode">Kode Wilayah </label>
		                    <div class="col-md-6 col-sm-6 col-xs-12">
		                      <input type="text" id="kode" class="form-control col-md-7 col-xs-12" name="kode" placeholder="Kode Wilayah" required="required" value="" maxlength="10">
		                    </div>
		                </div>
		                ...
		                <div class="form-group">
		                    ...
		                    <div class="col-md-6 col-sm-6 col-xs-12">
		                      <input type="text" id="nama" class="form-control col-md-7 col-xs-12" name="nama" placeholder="Nama Wilayah" value="" required="required" maxlength="20">
		                    </div>
		                </div>
...
<script type="text/javascript">
	...
	function checkDataWil(){
      var kode     = $('#kode').val();
      var nama     = $('#nama').val();
     
      if(kode == ''){
        showWarning(2000, '', 'Kode Wilayah Masih Kosong !', true);
        $('#kode').focus();
        return false;
      }else if (nama == ''){
      	showWarning(2000, '', 'Nama Wilayah Masih Kosong !', true);
        $('#nama').focus();
        return false;
      }else{
        return true;

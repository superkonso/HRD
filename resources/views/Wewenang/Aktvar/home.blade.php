...
@section('title', Auth::User()->cPanel->TCpanel_AppName.' | Akuntansi ')

@section('content_header', 'Variabel Akuntansi ')
...
@section('content')
	...
	<div class="row">
		<div class="form-group col-md-12 col-sm-12 col-xs-12">
			<div class="box box-primary">
		      ...
		      <div class="box-body">
	        	<a href="aktvar/create" class="btn btn-success"><img src="{!! asset('images/icon/add-icon.png') !!}" width="20" height="20"> Tambah Akuntansi </a>
	        	<br><br>
	        	<div class="form-group">
	              <div class="input-group">
	                ...
	                <input type="text" id="searchkey" class="form-control pull-right" placeholder="Kode / Nama Akuntansi ">
	              </div>
	              <div class="input-group">
	                <button type="button" onclick="refreshData();" class="btn btn-primary"><img src="{!! asset('images/icon/refresh-icon.png') !!}" width="20" height="20"> Refresh</button>&nbsp;
	                 <a type="button" href="/ctkaktvar" class="btn btn-primary"><img src="{!! asset('images/icon/print-icon.png') !!}" width="20" height="20"> Print</a>
	              </div>
	            </div>
	...
	<script>
		...
		function refreshData(){
	    	...
	    	$.get('/ajax-getdataaktvar?key='+key, function(data){
	    		...
	    		if(data.length > 0){
	    			$.each(data, function(index, listaktobj){
		    			isiData += '<tr>'
						            ...
						            +'<td>'
										+'<a href="/aktvar/'+listaktobj.id+'/edit">'

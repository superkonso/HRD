...
@section('title', Auth::User()->cPanel->TCpanel_AppName.' | LAPORAN TARIF RADIOLOGI')

@section('content_header', 'Tarif RADIOLOGI')
    ...
    <div class="form-group col-md-12 col-sm-12 col-xs-12">
        <div class="box box-primary">      
            <div style="text-align: center;">
                <h3>LAPORAN DAFTAR TARIF RADIOLOGI <br> <b>SMART BRIDGE</b></h3>
            </div>     
...
<script>
	$( document ).ready(function() {
        ...
        isiData += '<thead>'
                        +'<th width="90px">Kode Tarif Rad</th>'
                        +'<th width="155px">Nama Tarif Rad</th>'
    	...
    	$.get('/ajax-tarifradprint', function(data){

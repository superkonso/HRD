...
@section('title', Auth::User()->cPanel->TCpanel_AppName.' | Tarif Lab Baru')

@section('content_header', 'Tambah Tarif Lab')
...
<div class="row">
	    <div class="col-md-12 col-sm-12 col-xs-12">
	        <div class="box box-primary">
	            ...
	            <div class="box-body">
	                <form class="form-horizontal form-label-left" action="/tariflab" method="post" novalidate data-parsley-validate onsubmit="return checkDataLab()">
		                {{csrf_field()}}

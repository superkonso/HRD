...
@section('title', Auth::User()->cPanel->TCpanel_AppName.' | Tarif Rawat Inap Baru')

@section('content_header', 'Input Tarif Inap Baru')
	    ...
	    <div class="col-md-12 col-sm-12 col-xs-12">
	        <div class="box box-primary">
	            <div class="box-header">
	                ...
	                @endif
	                <h3 class="box-title">Form Tarif Inap</h3>
	            </div>
	            <div class="box-body">
	                <form class="form-horizontal form-label-left" action="/tarifinap" method="post" novalidate data-parsley-validate onsubmit="return checkDataRI()">

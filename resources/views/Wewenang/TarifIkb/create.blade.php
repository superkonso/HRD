...
@section('title', Auth::User()->cPanel->TCpanel_AppName.' | Tarif Kamar Bersalin Baru')

@section('content_header', 'Input Tarif IKB Baru')
	    ...
	    <div class="col-md-12 col-sm-12 col-xs-12">
	        <div class="box box-primary">
	            <div class="box-header">
	                ...
	                @endif
	                <h3 class="box-title">Form Tarif IKB</h3>
	            </div>
	            <div class="box-body">
	                <form class="form-horizontal form-label-left" action="/tarifikb" method="post" novalidate data-parsley-validate onsubmit="return checkDataIkb()">

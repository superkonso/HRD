...
@section('title', Auth::User()->cPanel->TCpanel_AppName.' | Edit Tarif Fisio')

@section('content_header', 'Edit Tarif Fisio')
...
<div class="row">
	    <div class="col-md-12 col-sm-12 col-xs-12">
	        <div class="box box-primary">
	            ...
	            <div class="box-body">
	                <form class="form-horizontal form-label-left" action="/tariffisio/{{$tarif->id}}" method="post" novalidate>
		                {{csrf_field()}}
    				    {{method_field('PUT')}}
		                ...
		                <div class="form-group">
		                    ...
		                    <div class="col-md-3 col-sm-3 col-xs-6">
		                      <input type="text" id="kode" class="form-control col-md-7 col-xs-12" readonly="readonly" name"kode" placeholder="Tarif Kode" required="required" value="{{$tarif->TTarifFisio_Kode}}">
		                    </div>
		                </div>
		                ...
		                <div class="form-group">
		                    ...
		                    <div class="col-md-3 col-sm-3 col-xs-12">
		                     <select id="status" name="status" class="form-control col-md-7 col-xs-12">
		                     	<option value="A" @if(!empty($tarif->TTarifFisio_Status)) @if ("A"==$tarif->TTarifFisio_Status) selected="selected" @endif @endif>Aktif</option>
		                     	<option value="N" @if(!empty($tarif->TTarifFisio_Status)) @if ("N"==$tarif->TTarifFisio_Status) selected="selected" @endif @endif>Non Aktif</option>
		                     </select>
		                    </div>
		                </div>
		                ...
		                <div class="form-group">
		                    ...
		                    <div class="col-md-6 col-sm-6 col-xs-12">
		                      <input type="text" id="nama" class="form-control col-md-7 col-xs-12" name="nama" placeholder="Tarif Nama" value="{{$tarif->TTarifFisio_Nama}}" required="required" >
		                    </div>
		                </div>
		                ...
		                <div class="form-group">
		                    ...
		                    <div class="col-md-6 col-sm-6 col-xs-12">
		                      <input type="text" id="tvip" class="form-control col-md-7 col-xs-12" name="tvip" placeholder="0" value="{{$tarif->TTarifFisio_VIP}}" onkeyup="changeFormat(this.id, this.value)">
		                    </div>
		                </div>
		                 ...
		                 <div class="form-group">
		                    ...
		                    <div class="col-md-6 col-sm-6 col-xs-12">
		                      <input type="text" id="tutm" class="form-control col-md-7 col-xs-12" name="tutm" placeholder="0" value="{{$tarif->TTarifFisio_Utama}}" onkeyup="changeFormat(this.id, this.value)">
		                    </div>
		                </div>
		                ...
		                <div class="form-group">
		                    ...
		                    <div class="col-md-6 col-sm-6 col-xs-12">
		                      <input type="text" id="tkls1" class="form-control col-md-7 col-xs-12" name="tkls1" placeholder="0" value="{{$tarif->TTarifFisio_Kelas1}}" onkeyup="changeFormat(this.id, this.value)">
		                    </div>
		                </div>
		                ...
		                <div class="form-group">
		                    ...
		                    <div class="col-md-6 col-sm-6 col-xs-12">
		                      <input type="text" id="tkls2" class="form-control col-md-7 col-xs-12" name="tkls2" placeholder="0" value="{{$tarif->TTarifFisio_Kelas2}}" onkeyup="changeFormat(this.id, this.value)">
		                    </div>
		                </div>
		                ...
		                <div class="form-group">
		                    ...
		                    <div class="col-md-6 col-sm-6 col-xs-12">
		                      <input type="text" id="tkls3" class="form-control col-md-7 col-xs-12" name="tkls3" placeholder="0" value="{{$tarif->TTarifFisio_Kelas3}}" onkeyup="changeFormat(this.id, this.value)">
		                    </div>
		                </div>
		                ...
		                <div class="form-group">
		                    ...
		                    <div class="col-md-6 col-sm-6 col-xs-12">
		                      <input type="text" id="tjalan" class="form-control col-md-7 col-xs-12" name="tjalan" placeholder="0" value="{{$tarif->TTarifFisio_Jalan}}" onkeyup="changeFormat(this.id, this.value)">
		                    </div>
		                </div>

...
<div class="row">
	<form action="/ctktariffisio" method="post" data-parsley-validate >
	...
	<div class="form-group col-md-12 col-sm-12 col-xs-12">
		<div class="box box-primary">
	        ...
	        <div class="box-body">
	        	@if($viewonly==0)
	        	<a href="/tariffisio/create" class="btn btn-success"><img src="{!! asset('images/icon/add-icon.png') !!}" width="20" height="20"> Tambah Tarif Baru</a>
	        	<br><br>
	        	@endif
	        	<div class="form-group">
	              ...
	              <div class="input-group">
	                ...
	                <button type="submit" href="/ctktariffisio" class="btn btn-primary"><img src="{!! asset('images/icon/print-icon.png') !!}" width="20" height="20"> Print</button>
	              </div>
	            </div>
...
<script>
	...
	function refreshData(){
    	...
    	$.get('/ajax-tariffisiomaster?kuncicari='+key, function(data){
    		...
    		if(data.length > 0){
    			$.each(data, function(index, listTariffisioObj){
	    			isiData += '<tr>'
					            ...
					            +'<td>'
									+(vonly=='0' ? '<a href="/tariffisio/'+listTariffisioObj.id+'/edit">'+'<img src="{!! asset('images/icon/edit2-icon.png') !!}" width="20" height="20" title="Edit">'+'</a>' : '')
								+'</td>'
					        +'</tr>';
	    		});

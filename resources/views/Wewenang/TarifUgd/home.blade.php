...
@section('title', Auth::User()->cPanel->TCpanel_AppName.' | Tarif UGD')
...
<div class="row">
	<div class="form-group col-md-12 col-sm-12 col-xs-12">
		<div class="box box-primary">
	        ...
	        <div class="box-body">
	        	<a href="/tarifugd/create" class="btn btn-success"><img src="{!! asset('images/icon/add-icon.png') !!}" width="20" height="20"> Tambah Tarif UGD Baru</a>
	        	<br><br>
	        	<div class="form-group">
	              ...
	              <div class="input-group">
	                ...
	                <a type="button" href="/ctktarifugd" class="btn btn-primary"><img src="{!! asset('images/icon/print-icon.png') !!}" width="20" height="20"> Print</a>
	              </div>
	            </div>
...
<script>
	...
	function refreshData(){
    	...
    	$.get('/ajax-tarifugdmaster?kuncicari='+key, function(data){
    		...
    		if(data.length > 0){
    			$.each(data, function(index, listTarifIGDObj){
	    			isiData += '<tr>'
					            ...
					            +'<td>'
									+'<a href="/tarifugd/'+listTarifIGDObj.id+'/edit">'

...
@section('title', Auth::User()->cPanel->TCpanel_AppName.' | Update User')

@section('content_header', 'Update User')

@section('header_description', 'update user')

@section('menu_desc', 'user')

@section('link_menu_desc', '/user')

@section('sub_menu_desc', 'updateuser')
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                <form class="form-horizontal" role="form" method="POST" action="/updateprofile/{{$users->id}}" enctype="multipart/form-data">
                ...
                <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="first_name" type="text" class="form-control" name="first_name" value="{{$users->first_name}}" required autofocus>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="last_name" type="text" class="form-control" name="last_name" value="{{$users->last_name}}">
                ...
                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                    <label for="email" class="control-label col-md-3 col-sm-3 col-xs-12">E-Mail Address</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <select name="unit" id="unit" class="form-control col-md-7 col-xs-12">
                        ...
                        @foreach($units as $unit)
                            <option value="{{$unit->TUnit_Kode}}" @if($users->TUnit_Kode == $unit->TUnit_Kode) selected="selected" @endif>{{$unit->TUnit_Nama}}</option>
                        @endforeach
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <select name="pelaku" id="pelaku">
                        ...
                        @foreach($pelakus as $data)
                            <option value="{{$data->TPelaku_Kode}}" @if($users->TPelaku_Kode == $data->TPelaku_Kode) selected="selected" @endif>{{$data->TPelaku_NamaLengkap}}</option>
                        @endforeach
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <select name="accessid" id="accessid" class="form-control col-md-7 col-xs-12">
                        ...
                        @foreach($access as $akses)
                            <option value="{{$akses->TAccess_Code}}" @if($users->TAccess_Code == $akses->TAccess_Code) selected="selected" @endif>{{$akses->TAccess_Name}}</option>
                        @endforeach
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div><img width="100px" height="100px" src="@if(is_null($users->foto) or $users->foto == '') {{ asset('images/user/') }}/userdefaultimg.jpg @else {{ asset('images/user/') }}\{{$users->foto}} @endif"></img></div><br>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <a href="/home" class="btn btn-danger"><img src="{!! asset('images/icon/cancel-icon.png') !!}" width="20" height="20"> Cancel</a>
                    </div>
                </div>
                </form>
            </div>

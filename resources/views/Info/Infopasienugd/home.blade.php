...
@section('title', Auth::User()->cPanel->TCpanel_AppName.' | Info Pasien UGD')

@section('content_header', 'Info Pasien UGD')

@section('header_description', 'Info Pasien UGD')

@section('menu_desc', 'infopasienugd')

@section('link_menu_desc', '/infopasienugd')
  ...
  <div class="form-group col-md-12 col-sm-12 col-xs-12">
    <div class="box box-primary">
        <div class="box-header">
          <h3 class="box-title">Info Pasien UGD</h3>
           ...
           <div class="input-group">
              <div class="input-group-addon" style="background-color: #167F92;">
                ...
                <div class="input-group-addon" style="background-color: #167F92;">
                  ...
                  <input type="text" name="searchkey3" id="searchkey3" class="form-control pull-right" placeholder="No Reg / No RM / Nama Pasien">
                </div>
...
<script>
  ...
  function refreshData(){
      ...
      $.get('/ajax-getvinfopasienugd?key1='+key1+'&key2='+key2+'&key3='+key3, function(data){

        if(data.length > 0){
          $.each(data, function(index, listpoliObj){
            isiData += '<tr>'
                  +'<td class="" width="15%">'+listpoliObj.TRawatUGD_NoReg+'</td>'
                      +'<td class="" width="15%">'+listpoliObj.TRawatUGD_Tanggal+'</td>'
                      ...
                      +'<td class="" width="15%">'+listpoliObj.TPasien_KlgTelp+'</td>'

...
class ObattransController extends Controller
{
    ...
    {
        $this->middleware('MenuLevelCheck:02,002');
    }
    ...
    public function index()
    {
      date_default_timezone_set("Asia/Bangkok");
        ...
        return view::make('Ugd.Obattrans.create', compact('autoNumber', 'units', 'pelakus', 'admvars', 'tarifvars', 'provinsi', 'prsh'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // ============================================= validation ==================================
            ...
            if(empty($request->pasiennorm) || empty($request->nama) || $request->pasiennorm == '' || $request->nama == ''){
                session()->flash('validate', 'Silahkan lengkapi Data Transaksi Obat dan Alkes UGD !');
                return redirect('transobatugd');
            }

            if(count($dataTransObat) < 1){
                session()->flash('validate', 'Transaksi Obat dan Alkes UGD Masih Kosong!');
                return redirect('transobatugd');
            }
        // ============================================================================================
        ...
        $obatkmr->TObatKmr_Jenis            = 'U';
        $obatkmr->TObatKmr_TTNomor          = '';
        $obatkmr->TObatKmr_KelasKode        = 'U';
        $obatkmr->TRawatJalan_NoReg         = $request->ugd_nomor;
        ...
        if($obatkmr->save()){
            ...
            for($n=0; $n<=$i-1; $n++){
                ...
                ${'obatrngkartu'.$n}->TObatRngKartu_Keterangan     = 'Pemakaian OHP UGD a/n : '.$request->nama;
                ...
                ${'stockmovingAVG'.$n}->TStockMovingAVG_TransKeterangan    = 'Pemakaian OHP UGD a/n : '.$request->nama;
            ...
            // ========================= simpan ke tlogbook ==============================
                    ...
                    $logbook->TLogBook_LogKeterangan = 'Transaksi Obat dan Alkes UGD a/n : '.$obatkmr->TObatKmr_PasienNama;
                    $logbook->TLogBook_LogJumlah    = (int)$obatkmr->TObatKmr_Jumlah;
                    $logbook->IDRS                  = '1';

                    if($logbook->save()){
                        \DB::commit();
                        session()->flash('message', 'Transaksi Obat dan Alkes UGD Berhasil Disimpan');
                    }
            // ===========================================================================
        }   
    ...
    {
        return view::make('Ugd.Obattrans.home');
    }
    ...
    public function edit($id)
    {
       date_default_timezone_set("Asia/Bangkok");
        ...
        $obatkmrs = Obatkmr::
                leftJoin('trawatugd AS RJ', 'tobatkmr.TRawatJalan_NoReg', '=', 'RJ.TRawatUGD_NoReg')
                ...
                ->select('tobatkmr.*', 'RJ.TPelaku_Kode','P.TPerusahaan_Nama', 'D.TPelaku_NamaLengkap')
        ...
        return view::make('Ugd.Obattrans.edit', compact('obatkmrs', 'obatkmrdetils','prsh','vtransdaftar'));
    ...
    public function update(Request $request, $id)
    {
        ...
        $obatkmr->TObatKmr_Nomor            = $request->jalantransno;
        //$obatkmr->TObatKmr_Tanggal          = $tgltrans;
        $obatkmr->TObatKmr_Jenis            = 'U';
        $obatkmr->TObatKmr_TTNomor          = '';
        $obatkmr->TObatKmr_KelasKode        = 'U';
        ...
        if($obatkmr->save()){
            ...
            for($n=0; $n<=$i-1; $n++){
                ...
                ${'stockmovingAVG'.$n}->TStockMovingAVG_UserID             = (int)Auth::User()->id;
                ${'stockmovingAVG'.$n}->TStockMovingAVG_UserDate           = date('Y-m-d H:i:s');
                ${'stockmovingAVG'.$n}->TUnit_Kode                         = '030';
                ${'stockmovingAVG'.$n}->IDRS                               = 1;
            ...
            // ========================= simpan ke tlogbook ==============================
                    ...
                    $logbook->IDRS                  = '1';
                     ...
                     if($logbook->save()){
                        \DB::commit();
                        session()->flash('message', 'Edit Transaksi Obat dan Alkes UGD Berhasil Disimpan');
                    }
            // ===========================================================================
        }   

        return redirect('transobatugd/show');
    }

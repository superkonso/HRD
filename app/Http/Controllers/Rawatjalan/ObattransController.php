...
class ObattransController extends Controller
{
    ...
    {
        $this->middleware('MenuLevelCheck:03,002');
    }
    ...
    public function index()
    {
        ...
        return view::make('Rawatjalan.Obattrans.create', compact('autoNumber', 'units', 'pelakus', 'admvars', 'tarifvars', 'provinsi', 'prsh'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // ============================================= validation ==================================
            ...
            if(empty($request->pasiennorm) || empty($request->nama) || $request->pasiennorm == '' || $request->nama == ''){
                ...
                return redirect('transobatjalan');
            }
        ...
        $obatkmr->TObatKmr_Jenis            = 'J';
        $obatkmr->TObatKmr_TTNomor          = '';
        $obatkmr->TObatKmr_KelasKode        = 'J';
        ...
        if($obatkmr->save()){
            ...
            for($n=0; $n<=$i-1; $n++){
                ...
                ${'obatrngkartu'.$n}->TObatRngKartu_Keterangan     = 'Pemakaian OHP Rajal a/n : '.$request->nama;
                ...
                ${'stockmovingAVG'.$n}->TStockMovingAVG_TransKeterangan    = 'Pemakaian OHP Rajal a/n : '.$request->nama;
            ...
            // ========================= simpan ke tlogbook ==============================
                    ...
                    $logbook->TLogBook_LogKeterangan = 'Transaksi Obat dan Alkes Rajal a/n : '.$obatkmr->TObatKmr_PasienNama;
    ...
    {
        return view::make('Rawatjalan.Obattrans.home');
    }
    ...
    public function edit($id)
    {
        ...
        $obatkmrs = Obatkmr::
                leftJoin('trawatjalan AS RJ', 'tobatkmr.TRawatJalan_NoReg', '=', 'RJ.TRawatJalan_NoReg')
                ->leftJoin('tperusahaan AS P', 'RJ.TPerusahaan_Kode', '=', 'P.TPerusahaan_Kode')
        ...
        return view::make('Rawatjalan.Obattrans.edit', compact('obatkmrs', 'obatkmrdetils','vtransdaftar'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($obatkmr->save()){
            ...
            // ========================= simpan ke tlogbook ==============================
                    ...
                    $logbook->TLogBook_LogIPAddress = $ip;
                    $logbook->TLogBook_LogDate      = date('Y-m-d H:i:s');
                    $logbook->TLogBook_LogMenuNo    = '03002';
                    $logbook->TLogBook_LogMenuNama  = url()->current();
                    ...
                    if($logbook->save()){
                        \DB::commit();
                        session()->flash('message', 'Transaksi Obat dan Alkes Berhasil Diedit');
                    }
            // ===========================================================================

        }   

        return redirect('transobatjalan/show');
    }

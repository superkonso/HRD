...
class ObatunitopnameController extends Controller
{
    public function __construct()
    {
        $this->middleware('MenuLevelCheck:06,106');
    }
    ...
    public function index()
    {
        ...
        $units      = Unit::whereNotIn('TUnit_Kode', array('031','081'))->get();
    ...
    public function store(Request $request)
    {
        ...
        // ============================================= validation ==================================
            ...
            if(empty($request->nomortrans) || $request->nomortrans == ''){
                ...
                return redirect('/obatopnameunit');
                exit();
            }
        // ============================================================================================
        ...
        $logbook->TLogBook_LogMenuNo    = '106';
    ...
    public function edit($id)
    {
        ...
        $units      = Unit::whereNotIn('TUnit_Kode', array('031','081'))->get();
        $grups      = Grup::where('TGrup_Jenis', '=', 'OBAT')->orderBy('TGrup_Nama', 'ASC')->get();
        $unit       = Unit::where('TUnit_Kode', '=', $opnames->TUnit_Kode)->first();
        $unitnama   = ucwords(strtolower($unit->TUnit_Nama));
        $link       ='/obatopnameunit';

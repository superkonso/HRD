...
class ObattransController extends Controller
{
    ...
    {
        $this->middleware('MenuLevelCheck:07,003');
    }
    ...
    public function index()
    {
        ...
        $autoNumber = autoNumberTrans::autoNumber('PBL-'.$tgl.'-', '4', false);

        return view::make('Laboratorium.Obattrans.create', compact('autoNumber', 'units', 'pelakus', 'admvars', 'tarifvars', 'provinsi', 'prsh'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($obatkmr->save()){
            ...
            for($n=0; $n<=$i-1; $n++){
                ...
                ${'obatrngkartu'.$n}->TObatRngKartu_Keterangan     = 'Pemakaian OHP LAB a/n : '.$request->nama;
                ...
                ${'stockmovingAVG'.$n}->TStockMovingAVG_TransKeterangan    = 'Pemakaian OHP LAB a/n : '.$request->nama;
            ...
            // ========================= simpan ke tlogbook ==============================
                    ...
                    $autoNumber = autoNumberTrans::autoNumber('PBL-'.$tgl.'-', '4', true);
                    ...
                    if($logbook->save()){
                        \DB::commit();
                        session()->flash('message', 'Transaksi Obat Laboratorium Berhasil Disimpan');
                    }
            // ===========================================================================
    ...
    {
        return view::make('Laboratorium.Obattrans.home');
    }
    ...
    public function edit($id)
    {
        ...
        return view::make('Laboratorium.Obattrans.edit', compact('obatkmrs', 'obatkmrdetils','vtransdaftar'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($obatkmr->save()){
            ...
            // ========================= simpan ke tlogbook ==============================
                    ...
                    if($logbook->save()){
                        \DB::commit();
                        session()->flash('message', 'Edit Transaksi Obat Laboratorium Berhasil Disimpan');
                    }
            // ===========================================================================

        }   

        return redirect('transobatlab/show');
    }

...
class KamartindakansController extends Controller
{
    ...
    public function index()
    {
        ...
        return view::make('Rawatinap.Kamartindakan.view', compact('autoNumber', 'units', 'pelakus', 'admvars', 'tarifvars', 'provinsi', 'prsh'));             
    }
    ...
    public function store(Request $request)
    {
        ...
        foreach($listtindakan as $data){
            ...
            ${'inaptrans'.$i}->TransKelompok           = 'TIN';
            ${'inaptrans'.$i}->TarifJenis              = $data->tarifvarkel;
            ${'inaptrans'.$i}->TransTanggal            = $nowDate;
            ${'inaptrans'.$i}->TransKeterangan         = 'Kamar Tindakan '.$data->tarifnama.' : '.$data->pelakunama;
            ...
            if(${'inaptrans'.$i}->save()){
                // ========================= simpan ke tlogbook ==============================
                    ...
                    $logbook->TLogBook_LogMenuNo        = '04004';
        ...
        \DB::commit();
        session()->flash('message', 'Transaksi Kamar Tindakan Rawat Inap Berhasil');

        return redirect('/kamartindakan');

    }

    public function show($id)
    {
        return View::make('Rawatinap.Kamartindakan.home');
    }
    ...
    public function edit($id)
    {
        ...
        return view::make('Rawatinap.Kamartindakan.edit', compact('autoNumber', 'units', 'pelakus', 'admvars', 'tarifvars', 'provinsi', 'prsh', 'listtindmedis', 'rawatinaps'));  
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        \DB::commit();
        session()->flash('message', 'Edit Transaksi Kamar Tindakan Rawat Inap Berhasil');

        return redirect('/kamartindakan/show');
    }
